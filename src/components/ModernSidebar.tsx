...
export const ModernSidebar: React.FC<ModernSidebarProps> = ({ isOpen, onClose }) => {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      icon: TestTube,
      path: '/test',
      description: 'Test AI generation quality'
    }
  ];
  ...
  const quickActions = [
    {
      ...
      icon: Presentation,
      onClick: () => {
        // Navigate to presentations feature
    ...
    },
    {
      ...
      icon: Database,
      onClick: () => {
        // Navigate to enterprise features
        console.log('Navigate to enterprise export');
      },
              ...
              {quickActions.map((action) => {
                ...
                return (
                  <Button
                    key={action.id}
                    variant="ghost"
                    className="w-full justify-start h-auto p-3 hover:bg-gradient-to-r hover:from-purple-50 hover:to-blue-50 text-gray-600 hover:text-gray-800"
